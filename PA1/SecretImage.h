...
private:
    int *upper_triangular = nullptr; // Array for upper triangular part (including diagonal)
    int *lower_triangular = nullptr; // Array for lower triangular part (excluding diagonal)
    int width, height;
...
public:
    ...
    //Stores data lines for the upper and lower triangular matrices
    static void process_file(std::string line, int* data);
