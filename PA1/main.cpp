...
int main(int argc, char** argv) {
    ...
    try {
        ...
        if (operation == "mean") {
            ...
            //apply_mean_filter("creep.jpg", 19);
            // apply_gaussian_smoothing("puppy.png", 41, 4);
            // apply_unsharp_mask("flowers.png", 9, 10);
            // add_images("image1.png", "image2.png");
            // subtract_images("image1.png", "image2.png");
            // compare_images("image1.png", "image2.png");
            // disguise_image("flowers.png");
            // reveal_image("secret_image_flowers.dat");
            // encrypt_image("puppy.png", "I want to fix memory error");
            // decrypt_image("puppy_with_secret_message_embedded.png", 37);
